//Thu Dec 18 2025 05:47:03 GMT+0000 (Coordinated Universal Time)
...
class _0x520715 extends _0x49bd9d {
  ...
  async midAutumn2024_weeklyGiftStatus(_0x33f330 = {}) {
    try {
      let _0xa75291 = {
          fn: "midAutumn2024_weeklyGiftStatus",
          method: "post",
        ...
        for (let _0x28b798 of _0x28ed17) {
          if (!_0x28b798.received) {
            ...
            if (_0x379521 >= _0x2776b9.getTime() && _0x379521 <= _0x2a80e7.getTime()) {
              await this.midAutumn2024_receiveWeeklyGift();
            }
          }
        }
      } else {
  ...
  async midAutumn2024_receiveWeeklyGift(_0x7bf582 = {}) {
    try {
      ...
      let _0x1a90d0 = {
          fn: "midAutumn2024_receiveWeeklyGift",
          method: "post",
  ...
  async midAutumn2024_taskList(_0x235da4 = {}) {
    try {
      let _0x38b811 = {
          fn: "midAutumn2024_taskList",
          method: "post",
          url: "https://mcs-mimp-web.sf-express.com/mcs-mimp/commonPost/~memberNonactivity~activityTaskService~taskList",
          headers: {
            ...this.getSign()
      ...
      if (_0x10d679?.["success"]) {
        ...
        for (let _0x17684c of _0x45abaa.filter(_0x2b3e27 => _0x2b3e27.status == 1)) {
          ...
          for (let _0x18d9ee = 0; _0x18d9ee < _0x17684c.canReceiveTokenNum; _0x18d9ee++) {
            await this.midAutumn2024_fetchMixTaskReward(_0x17684c);
          }
        }
            ...
            default:
              {
                for (let _0x47b87a = 0; _0x47b87a < _0xf52a71.restFinishTime && !this.dragonBoat_black; _0x47b87a++) {
                  await this.midAutumn2024_finishTask(_0xf52a71);
                }
                break;
              }
          }
  ...
  async midAutumn2024_finishTask(_0x2fec7d, _0x26b7dd = {}) {
    try {
      const _0xcc4a1 = {
        taskCode: _0x2fec7d.taskCode
      };
      let _0xe0c2d2 = {
          fn: "midAutumn2024_finishTask",
          method: "post",
          url: "https://mcs-mimp-web.sf-express.com/mcs-mimp/commonPost/~memberEs~taskRecord~finishTask",
          headers: {
            ...this.getSign()
      ...
      _0x17f75a?.["success"] ? (this.log("端午完成任务[" + _0x2fec7d.taskName + "]成功"), await this.midAutumn2024_fetchMixTaskReward(_0x2fec7d)) : this.log("端午完成任务[" + _0x2fec7d.taskName + "]失败: " + (_0x17f75a?.["errorMessage"] || (_0x17f75a ? JSON.stringify(_0x17f75a) : "无返回")));
    } catch (_0x50edd6) {
      console.log(_0x50edd6);
    }
  }
  midAutumn2024_parse_item(_0x1e0a8b) {
    let _0x2f4cb3 = [];
  ...
  async midAutumn2024_fetchMixTaskReward(_0x199ce9, _0x89a081 = {}) {
    try {
      let _0x3235f2 = {
          fn: "midAutumn2024_fetchMixTaskReward",
          method: "post",
      ...
      if (_0xe9f22d?.["success"]) {
        let _0x4a224b = this.midAutumn2024_parse_item(_0xe9f22d?.["obj"]?.["receivedAccountList"] || []);
  ...
  async midAutumn2024_game_indexInfo(_0x4ea6e4 = {}) {
    try {
      let _0x5ebb2d = {
          fn: "midAutumn2024_game_indexInfo",
          method: "post",
      ...
      if (_0x1cdae1?.["success"]) {
        ...
        await this.midAutumn2024_game_init(_0x39f67c);
      } else {
  ...
  async midAutumn2024_game_init(_0x4390fe, _0x437d67 = {}) {
    try {
      let _0x24900b = {
          fn: "midAutumn2024_game_init",
          method: "post",
      ...
      if (_0x5637ee?.["success"]) {
        ...
        if (_0x31cca7 > 0) {
          ...
          for (let _0x5ced23 = _0x4477f0; _0x5ced23 <= _0x3b35d4; _0x5ced23++) {
            ...
            if (!(await this.midAutumn2024_boat_win(_0x5ced23))) {
              break;
            }
          }
        }
  ...
  async midAutumn2024_boat_win(_0x41d2ec = 1, _0x401fcd = {}) {
    let _0x3eed3e = true;
    try {
      const _0x56585c = {
      ...
      if (_0x17474d?.["success"]) {
        let _0x1b6957 = this.midAutumn2024_parse_item(_0x17474d?.["obj"]?.["currentAwardList"] || []);
  ...
  async midAutumn2024_coinStatus(_0x3059d5 = {}) {
    try {
      let _0x2263bb = {
        fn: "midAutumn2024_coinStatus",
        method: "post",
      ...
      if (_0x228aed?.["success"]) {
        ...
        while (_0x45da5d-- > 0) {
          await this.midAutumn2024_pushCoin();
        }
      } else {
      ...
      if (_0x19ac46?.["success"]) {
        let {
          ...
          _0x41ccf7 = this.midAutumn2024_parse_item(accountCurrencyList),
        ...
        while (_0x252cd5-- > 0) {
          await this.midAutumn2024_prizeDraw(4);
        }
      } else {
  ...
  async midAutumn2024_givePushTimes(_0x5c88c5 = {}) {
    let _0x3f8184 = true;
    try {
      let _0x35900b = {
        fn: "midAutumn2024_givePushTimes",
        method: "post",
  ...
  async midAutumn2024_pushCoin(_0x29d4dc = {}) {
    try {
      const _0x1f8a57 = {
        plateToken: null
      };
      let _0x322a6c = {
          fn: "midAutumn2024_pushCoin",
          method: "post",
      ...
      if (_0xf2ce07?.["success"]) {
        let _0x50c982 = this.midAutumn2024_parse_item(_0xf2ce07?.["obj"]?.["receivedAccountList"] || []);
  ...
  async midAutumn2024_coinStatus_checkDraw(_0x252dbf = {}) {
    try {
      let _0x342e17 = {
          fn: "midAutumn2024_coinStatus",
          method: "post",
      ...
      if (_0x562f60?.["success"]) {
        let {
          ...
          _0x2d6618 = this.midAutumn2024_parse_item(accountCurrencyList),
        ...
        while (_0x244ca0-- > 0) {
          if (await this.midAutumn2024_prizeDraw(4)) {
            this.coin -= 230;
          } else {
            break;
          }
        ...
        for (let _0x32dfdf of _0x1b2791) {
          while (this.coin >= _0x32dfdf.coin) {
            if (await this.midAutumn2024_prizeDraw(_0x32dfdf.idx)) {
  ...
  async midAutumn2024_prizeDraw(_0x2d53ba, _0x53a4ec = {}) {
    let _0x4dd177 = false;
    try {
      const _0x52237f = {
        drawType: _0x2d53ba
  ...
  async anniversary2024_draw_task(_0x428c50 = {}) {
    ...
    await this.midAutumn2024_coinStatus_checkDraw();
  }
  async midAutumn2024_task(_0xbf0e9e = {}) {
    let _0xfc310e = Date.now();
    if (_0xfc310e < 1725273996000 || _0xfc310e > 1726829196000) {
      return;
    }
    await this.midAutumn2024_weeklyGiftStatus();
    if (this.dragonBoat_black) {
      return;
    }
    await this.midAutumn2024_game_indexInfo();
    await this.midAutumn2024_taskList();
    await this.midAutumn2024_givePushTimes();
    await this.midAutumn2024_coinStatus();
  }
  async midAutumn2024_draw_task(_0xad36aa = {}) {
